public class stringscwh {
    public static void main(String[] args) {
        ...
        // .substring(start,end) returns the sub string from the starting index till
        ...
        // .equals("string") returns true if the string matches and false if it doesn't
        System.out.print("Does the string match:");
        System.out.println(name.equals("abhi"));

        // .equalsIgnoreCase("string") it ignores the case (either upper or
        // lower)returns true if the string matches and false if it doesn't
        System.out.print("Does the string match:");
